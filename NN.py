...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 17 18:35:21 2021
...
try:
    model_bet0 = tf.keras.models.load_model("model_bet0")
    model_bet0.load_weights("model_bet0.h5")
    model_bet1 = tf.keras.models.load_model("model_bet1")
    model_bet1.load_weights("model_bet1.h5")
    model_bet2 = tf.keras.models.load_model("model_bet2")
    model_bet2.load_weights("model_bet2.h5")
    model_bet3 = tf.keras.models.load_model("model_bet3")
    model_bet3.load_weights("model_bet3.h5")
    model_bet = {0: model_bet0, 1: model_bet1, 2: model_bet2, 3: model_bet3}
    print("Networks for beting have been loaded")
except:
    print("Networks for beting should be build")
...
def save_model_bet():
    for i in range(3):
        model_bet[i].save_weights( "model_bet"+str(i)+".h5")
        

try:
    model_play0 = tf.keras.models.load_model("model_play0")
    model_play0.load_weights("model_play0.h5")
    model_play1 = tf.keras.models.load_model("model_play1")
    model_play0.load_weights("model_play1.h5")
    model_play2 = tf.keras.models.load_model("model_play2")
    model_play2.load_weights("model_play2.h5")
    model_play3 = tf.keras.models.load_model("model_play3")
    model_play3.load_weights("model_play3.h5")
...
def save_model_play():
    for i in range(3):
        model_play[i].save_weights( "model_play"+str(i)+".h5")