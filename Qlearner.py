...
class Qlearner(Player):
    ...
    def bet(self, others_bet):
        ...
        if np.random.rand() < self._epsilon:
            self._bet = Qlearner.betRandom(self)
        else:
    ...
    def actualize_bet(self, learning):
        if learning:
    ...
    def actualize_play(self, new_state, game_round, learning):  # end is  if at round 13
